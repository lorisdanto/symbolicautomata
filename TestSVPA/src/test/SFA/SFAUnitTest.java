...
public class SFAUnitTest {
	...
	public void testIntersectionWith() {
		try {
			...
			SFA<CharPred, Character> intersection = autA.intersectionWith(autB,
					ba);

			List<Character> la = Arrays.asList((char) 10, (char) 10);
			List<Character> lb = Arrays.asList((char) 11, (char) 3);
			List<Character> lab = Arrays.asList((char) 11, (char) 11);
	...
	public void testMinimization() {
		try {
			...
			List<Character> la = Arrays.asList('a', 'b');
			List<Character> lnot = Arrays.asList('1', '1');
...
//	private SFA<CharPred, Character> getSFAtoMin(CharSolver ba)
//			throws AutomataException {
//
//		CharPred geq0 = new CharPred((char) 10, (char) Character.MAX_VALUE);
//
