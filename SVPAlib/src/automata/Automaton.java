...
public abstract class Automaton<P, S> {
	 ...
	 */
	public HashSet<List<S>> getWitnesses(BooleanAlgebra<P, S> ba, int howMany) {
		if (isEmpty)
			return null;
	...
	protected Collection<Integer> getNextState(Collection<Integer> currState, S inputElement, BooleanAlgebra<P, S> ba) {
