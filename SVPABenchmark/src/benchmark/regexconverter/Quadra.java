...
public class Quadra {
	...
	public Quadra(int index1, int index2, int index3, int index4, SAFA<CharPred, Character> safa1, SAFA<CharPred, Character> safa2, SAFA<CharPred, Character> safa3, SAFA<CharPred, Character> safa4){
	...
	public Quadra(int index1, int index2, int index3, int index4, SFA<CharPred, Character> sfa1, SFA<CharPred, Character> sfa2, SFA<CharPred, Character> sfa3, SFA<CharPred, Character> sfa4){
		this.firstIndex = index1;
		this.secondIndex = index2;
		this.thirdIndex = index3;
		this.fourthIndex = index4;
