...
public class Triple {
	...
	public Triple(int index1, int index2, int index3, SAFA<CharPred, Character> safa1, SAFA<CharPred, Character> safa2, SAFA<CharPred, Character> safa3){
	...
	public Triple(int index1, int index2, int index3, SFA<CharPred, Character> sfa1, SFA<CharPred, Character> sfa2, SFA<CharPred, Character> sfa3){
		this.firstIndex = index1;
		this.secondIndex = index2;
		this.thirdIndex = index3;
		this.mySFA1 = sfa1;
